...
local function toggleNoClip()
    ...
    if character then
        ...
        if humanoid and rootPart then
            humanoid:SetStateEnabled(Enum.HumanoidStateType.Physics, not noClipEnabled)  -- Desativa a física do corpo
...
local function toggleSpeed()
    ...
    if character and character:FindFirstChild("Humanoid") then
        character.Humanoid.WalkSpeed = speedEnabled and 100 or 16  -- Aumentando a velocidade para 100
    end
end
