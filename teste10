...
-- Função para fechar o painel completamente
local function closePanel()
    screenGui:Destroy()  -- Destrói o painel inteiro
    disableAllFunctions()  -- Desativa todas as funções quando o painel for destruído
end
...
UserInputService.InputBegan:Connect(function(input)
    ...
    -- Fechar o painel quando pressionar a tecla "9"
